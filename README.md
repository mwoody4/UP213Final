...
2. Conduct a cluster analysis using SNAP gap and SNAP participation rates
...
`0_Project intro & Data prep`: Prepping dataset: pull data from American Community Survey, variable creation, and join with spatial data
